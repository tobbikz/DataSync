...
MariaDbRetryOptions mariadb_retry_options() {
...
TableLoadOutcome load_one_table(
    ...
    const MariaDbRetryOptions retry_pre = mariadb_retry_options();
    ...
    const MariaDbRetryOptions retry = mariadb_retry_options();
